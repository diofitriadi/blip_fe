  ...
  return (
    <aside className="h-screen sticky top-0" aria-label="Sidebar">
      <div className="overflow-y-auto py-4 px-3 h-screen bg-[#1F1D2B]">
        <div className='flex flex-col items-center w-20 h-full gap-4'>
          <button>
          ...
          <button>
            {pathname === '/' ? (
              <Link to='/'>
                <div className='w-full bg-[#252836] pr-4 ml-4 rounded-l-3xl'>
          ...
          <button>
            {pathname === '/dashboard' ? (
              ...
              <Link to='/dashboard'>
                <div className='w-full h-[70px] flex items-center justify-center rounded-tr-xl'>
          ...
          <button >
            {pathname === '/settings' ? (
              <Link to='/settings'>
                <div className='w-full bg-[#252836] pr-4 ml-4 pl-2 rounded-l-3xl'>
                  <div className='w-[70px] h-[70px] flex justify-center items-center '>
